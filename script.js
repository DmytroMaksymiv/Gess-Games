...
const score1El = document.getElementById('score--1');      // beter way
...
btnRoll.addEventListener('click', function() {
    if(playing) {
        ...
        //3. check for reloud, swich to neht plyer
...
btnHold.addEventListener('click', function() {
    ...
    scores[activPlayer] = scores + currentScore;
